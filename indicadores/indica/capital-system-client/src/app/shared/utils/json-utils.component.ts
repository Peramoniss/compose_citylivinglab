import { DateUtils } from "./date-utils.component";
...
export class JsonUtils {
  ...
  /**
     ...
     */
  public assign(target: Object, source: Object|any) {
    let dateUtils = DateUtils.getInstance();
